<div class="container  inset-0 flex items-center gap-2 justify-center mt-36">
    <div class="flex items-center p-8 bg-white shadow rounded-lg w-[21rem] ">
        ...
        <div>
            <span class="block text-2xl font-bold " id="jumlahAntrian">{{$jumlahAntrian}}</span>
    ...
    <div class="flex items-center p-8 bg-white shadow rounded-lg w-[21rem]">
        ...
        <div>
            <span class="block text-2xl font-bold" id="antrianSekarang">{{$antrianSekarang}}</span>
            <span class="block text-gray-500">Antrian Sekarang</span>
        </div>
    </div>
    <div class="flex items-center p-8 bg-white shadow rounded-lg w-[21rem]">
        ...
        <div>
            <span class="inline-block text-2xl font-bold" id="sisaAntrian">{{$sisaAntrian}}</span>
